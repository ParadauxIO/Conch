...
package io.paradaux.conch.sponge;

import com.google.inject.Inject;
import io.paradaux.conch.sponge.listeners.MessageChannelEventChatListener;
...
@Plugin(id = "conch", name = "Conch", version = "1.0.0", description = "Discord to chat Bridge")
